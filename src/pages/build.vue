  ...
  <div class="container">
    <div  class="">
        <div  class="flex items-center q-py-lg">
            ...
            <h3 class="text-h5 q-mr-sm">Build: {{build.name}} | Purpose: {{build.purpose}} | Rating: </h3>
          <q-rating
   ...
   <Build :weapon="build.weapon2" />
    ...
    <q-card dark class="q-mb-md">
      <q-card-section>
         <p class="text-h6 text-bold">Description</p>
    ...
    <p class="text-h6 text-bold">Feedback </p>
        <p v-if="!build.feedbacks.length>0">No feedback yet</p>
...
<div v-if="addFeedback" class="addFeedback q-mt-lg">
          <div class="flex q-mb-md"><p class="q-mb-none q-mr-md text-bold">Rating</p>
            <q-rating
              ...
              color="primary"
            /></div>
          <p class="text-bold">Feedback text</p>
          <q-input
          ...
          <q-btn  :loading="is_loading" :disable="!feedbackData.text.length>0 || !feedbackData.rating>0"
                 ...
                 icon="add" no-caps color="primary" text-color="dark" label="Send"/>
