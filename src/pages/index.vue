      ...
      <div class="page-wrapper">
        <div class="page-left">
          <div class="flex items-center ">
            ...
            <h3 class="text-h5">Social Networks</h3>
          </div>
          ...
          <div class="flex items-center no-wrap">
            ...
            <h3 class="text-h5">Latest news New World</h3>
          </div>
        ...
        <div class="page-right">
          <router-link to="/companies">
            <div class="flex items-center ">
              <q-icon size="30px" class="q-mr-md" color="primary" name="people_alt" />
              <h3 class="text-h5 text-title">Popular Companies</h3>
          ...
          <router-link to="/builds">
            <div class="flex items-center">
              ...
              <h3 class="text-h5 text-title">New builds</h3>
            </div>
          </router-link>
          ...
          <div class="text-center">
            ...
            <q-btn to="/skills" icon="add" no-caps color="primary" text-color="dark" label="Create build"/>
          </div>
        </div>
      </div>
    </div>
  ...
  meta: {
    ...
    meta: {
      ...
      ogTitle: {
        ...
        template(ogTitle) {
          return `Information site dedicated to the game New World.`
        }
      }
    }
  },
